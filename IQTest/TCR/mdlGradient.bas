...
Public Function Draw(gObject As Object, Angle As Single, FirstColor As Long, SecondColor As Long) As Boolean
...
mfAngle = Angle - 90
mlColor1 = FirstColor
mlColor2 = SecondColor

'gObject can be a Form or PictureBox.
Dim lRet    As Long
Dim lIdx    As Long
Dim lTime   As Long
...
Dim uaTmpPts()  As PointSng
    ...
    'this would slow things down. The gObject clipping region will take care of this.
...
Private Property Let FirstColor(ByVal lData As Long)
Dim lIdx As Long
mlColor1 = lData
If mlColor1 < 0 Then
...
Private Property Get FirstColor() As Long
    FirstColor = mlColor1
End Property

Private Property Let SecondColor(ByVal lData As Long)
Dim lIdx As Long
mlColor2 = lData
If mlColor2 < 0 Then
...
Private Property Get SecondColor() As Long
    SecondColor = mlColor2
End Property

Private Property Let Angle(ByVal fData As Single)
    mfAngle = -((CDbl(fData) - Int(Int(CDbl(fData) / 360#) * 360#)) - 270)
End Property
